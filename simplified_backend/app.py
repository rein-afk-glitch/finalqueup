...
# we should NOT use wildcard '*' with credentials. Instead, allow local + private LAN hosts.
_ALLOWED_ORIGINS = [
    r"http://localhost:8080",
    r"http://127\.0\.0\.1:8080",
    # Private LAN ranges commonly used for Wi‑Fi
    r"http://192\.168\.\d+\.\d+:8080",
    r"http://10\.\d+\.\d+\.\d+:8080",
    r"http://172\.(1[6-9]|2\d|3[0-1])\.\d+\.\d+:8080",
]
